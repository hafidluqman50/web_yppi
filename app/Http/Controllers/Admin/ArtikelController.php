...
class ArtikelController extends Controller
{
    public function index()
    {
		...
		return view('Pengurus.Admin.page.artikel.main',compact('title','page','data'));
    }

    public function tambah()
    {
		$title            = 'Form Artikel | Admin';
		$page             = 'artikel';
		$kategori_artikel = KategoriArtikel::where('status_delete',0)->get();
    	return view('Pengurus.Admin.page.artikel.form-artikel',compact('title','page','kategori_artikel'));
    }
    ...
    public function edit($id)
    {
		...
		$kategori_artikel = KategoriArtikel::where('status_delete',0)->get();
        return view('Pengurus.Admin.page.artikel.form-artikel',compact('title','page','kategori_artikel','row')); 
    }
    ...
    public function delete($id)
    {
        ...
        $get->delete();
        return redirect('/admin/data-artikel')->with('message','Berhasil Hapus Artikel');
    }
    ...
    { 
        ...
        if ($id == '') {
            ...
            if ($foto != '') {
                ...
                if (file_exists(public_path('assets/foto_artikel/'.$get))) {
                    unlink(public_path('assets/foto_artikel/'.$get));
                }
                $array = [
					'judul_artikel'       => $judul,
					'judul_slug_artikel'  => str_slug($judul,'-'),
        ...
        return redirect('/admin/data-artikel')->with('message',$message);
    }
}
