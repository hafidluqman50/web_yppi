...
class StreamingController extends Controller
{
	...
	{
		$title = 'Streaming | Admin';
		$page  = 'streaming';
		$data  = Streaming::getData();

		return view('Pengurus.Admin.page.streaming.main',compact('title','page','data'));
	}

	public function tambah()
	{
		$title            = 'Form Streaming | Admin';
		$page             = 'streaming';
		$jadwal_streaming = JadwalStreaming::all();

		return view('Pengurus.Admin.page.streaming.form-streaming',compact('title','page','jadwal_streaming'));
	}
	...
	public function edit($id)
	{
		...
		return view('Pengurus.Admin.page.streaming.form-streaming',compact('title','page','row','jadwal_streaming'));
	}
	...
	public function statusTampil($id)
	{
		...
		return redirect('/admin/data-streaming')->with('message','Berhasil Ubah Status Streaming');
	}
	...
	public function delete($id)
	{
		...
		return redirect('/admin/data-streaming')->with('message','Berhasil Hapus Streaming');
	}
	...
	public function save(Request $request)
	{
		...
		return redirect('/admin/data-streaming')->with('message',$message);
	}
}
