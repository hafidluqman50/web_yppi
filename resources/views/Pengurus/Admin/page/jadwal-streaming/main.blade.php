      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <a href="{{ url('/admin/data-jadwal-streaming/tambah') }}">
            ...
            <table class="table table-bordered" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $value->nama }}</td>
                  <td>
                    <a href="{{url('/admin/data-jadwal-streaming/edit',$value->id_jadwal_streaming)}}">
                      <button class="btn btn-warning">Edit</button>
                    </a>
                    <a href="{{url('/admin/data-jadwal-streaming/delete',$value->id_jadwal_streaming)}}">
