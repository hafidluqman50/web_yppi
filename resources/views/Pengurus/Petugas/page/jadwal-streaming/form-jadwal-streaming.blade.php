      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <a href="{{ url('/petugas/data-jadwal-streaming') }}">
              <button class="btn btn-default">
                <span class="fa fa-arrow-left"></span> Kembali
              </button>
            </a>
          </div>
      <form method="POST" action="{{url('/petugas/data-jadwal-streaming/save')}}">
            <div class="card-body">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="jadwal_streaming" placeholder="00.00 - 00.00" value="{{ isset($row) ? $row->jadwal_streaming : '' }}" required="required">
              </div>
