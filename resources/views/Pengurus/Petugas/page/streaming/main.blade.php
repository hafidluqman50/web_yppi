      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <a href="{{ url('/petugas/data-streaming/tambah') }}">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{url('/petugas/data-streaming/edit',$value->id_streaming)}}">
                      <button class="btn btn-warning">Edit</button>
                    </a>
                    <a href="{{url('/petugas/data-streaming/delete',$value->id_streaming)}}">
                      <button class="btn btn-danger" onclick="return confirm('Yakin Hapus ?');">Hapus</button>
                    </a>
                    <a href="{{ url('/petugas/data-streaming/status-tampil',$value->id_streaming) }}">
                      @if($value->status_tampil == 1)
